...
def _extract_predictions_and_losses(model,
    ...
    if not ignore_groundtruth:
        groundtruth = {
            ...
            fields.InputDataFields.groundtruth_boxecenter_3d:
            input_dict[fields.InputDataFields.groundtruth_boxecenter_3d],
        ...
        model.provide_groundtruth(
            [input_dict[fields.InputDataFields.groundtruth_boxes]],
            [input_dict[fields.InputDataFields.groundtruth_boxecenter_3d]],
            [tf.one_hot(input_dict[fields.InputDataFields.groundtruth_classes]- label_id_offset, depth=model.num_classes)],
            groundtruth_masks_list,
            groundtruth_keypoints_list)
        losses_dict.update(model.loss(prediction_dict, true_image_shapes))

    result_dict = eval_util.result_dict_for_single_example_with3dbox(
        original_image,
